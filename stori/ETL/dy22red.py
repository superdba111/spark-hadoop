...
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "dynamo", table_name = "trades", transformation_ctx = "datasource0", additional_options = {"jobBookmarkKeys":["id"],"jobBookmarkKeysSortOrder":"asc"})
## @type: ApplyMapping
...
## @type: DataSink
## @args: [catalog_connection = "reddb", connection_options = {"dbtable": "trades", "database": "dev"}, redshift_tmp_dir = TempDir, transformation_ctx = "datasink4"]
## @return: datasink4
